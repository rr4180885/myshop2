      ...
      >
        ...
        <div className="p-4 sm:p-6 border-b border-border">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="font-display font-bold text-foreground text-lg">Brother Enterprises</h1>
        ...
        <nav className="flex-1 px-3 py-4 sm:py-6 space-y-1 sm:space-y-2 overflow-y-auto">
          {tabs.map(tab => {
            ...
            return (
              ...
              >
                <Icon className={`w-5 h-5 shrink-0 transition-all ${isActive ? "text-primary" : ""}`} />
        ...
        <div className="p-3 sm:p-4 border-t border-border space-y-3">
          ...
          <Button
            ...
            size="sm"
            onClick={() => logout()}
            className="w-full hover:bg-destructive/20 hover:border-destructive/50 hover:text-destructive transition-all active:scale-95"
